...
data.to.plot <- cbind(Green.Carpet.Data, lat.long) 
...
data.to.plot <- cbind(pre.1980, lat.long) 
leics_df <- tidy(leics) # Need to load broom
#ggmap(leics_df)
#ggplot() +
 #   geom_path(data = leics_df, aes(x = long, y = lat, group = group)) +
...
data.to.plot <- cbind(Post.1980, lat.long) 
leics_df <- tidy(leics) # Need to load broom
#ggmap(leics_df)
#ggplot() +
 #   geom_path(data = leics_df, aes(x = long, y = lat, group = group)) +
...
data.to.plot <- cbind(Post.1980.Dates, lat.long) 
leics_df <- tidy(leics) # Need to load broom
#ggmap(leics_df)
#ggplot() +
 #   geom_path(data = leics_df, aes(x = long, y = lat, group = group)) +
